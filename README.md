...
# lab1 1.2 (20). Найти сумму цифр дробной M2 и сумму цифр целой части M1 вещественного числа. Вывести наибольшую сумму. 
# 2.1.(20) Разработать программу, меню которой позволяет выполнить следующие функции:
...
8. Выход из программы.следующие функции
# 2.2.(6) Численно убедиться в справедливости равенства, 
